...
void threads_render(){
	...
	threads.push_back(std::thread(render_scene_thread, 0, (TILES_WIDE / 4), 0, TILES_HIGH / 2));
	threads.push_back(std::thread(render_scene_thread, TILES_WIDE / 4, (TILES_WIDE / 2), 0, TILES_HIGH / 2));

	threads.push_back(std::thread(render_scene_thread, (TILES_WIDE / 2), (3 / 4)*TILES_WIDE, 0, (TILES_HIGH / 2)));
	threads.push_back(std::thread(render_scene_thread, (3 / 4)*TILES_WIDE, TILES_WIDE, 0, (TILES_HIGH / 2)));


	threads.push_back(std::thread(render_scene_thread, TILES_WIDE / 2, (3 / 4) *TILES_WIDE, TILES_HIGH / 2, TILES_HIGH));
	threads.push_back(std::thread(render_scene_thread, (3 / 4) * TILES_WIDE, TILES_WIDE, TILES_HIGH / 2, TILES_HIGH));

	threads.push_back(std::thread(render_scene_thread, 0, (TILES_WIDE / 4), TILES_HIGH / 2, TILES_HIGH));
	threads.push_back(std::thread(render_scene_thread, TILES_WIDE / 4, (TILES_WIDE / 2), TILES_HIGH / 2, TILES_HIGH));
